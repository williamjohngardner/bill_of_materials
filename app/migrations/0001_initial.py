# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-19 21:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subassembly_quantity', models.IntegerField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='subassembly',
            name='part_list',
            field=models.ManyToManyField(through='app.Quantity', to='app.Part'),
        ),
        migrations.AddField(
            model_name='subassembly',
            name='plating',
        ...
        migrations.AddField(
            model_name='subassembly',
            name='subassembly_list',
            field=models.ManyToManyField(blank=True, null=True, to='app.SubAssembly'),
        ),
        migrations.AddField(
            model_name='quantity',
            name='assembly',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.SubAssembly'),
        ),
        migrations.AddField(
            model_name='quantity',
            name='part',
